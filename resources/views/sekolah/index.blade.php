					                            ...
					                            <tbody>
					                                ...
					                                <tr>
														...
														<td class="table-action" style="vertical-align: middle;">
															...
															<form method="POST" action="" id="delete-form-{{ $item->id_sekolah }}">
																@csrf
                												@method('DELETE')
																<a href="/admin/sekolah/destroy/{{ $item->id_sekolah }}" class="btn btn-sm btn-danger" onclick="confirmDelete({{ $item->id_sekolah }})">Hapus</a>				
															</form>	
                                                            </div>													
														</td>
					                                </tr>
